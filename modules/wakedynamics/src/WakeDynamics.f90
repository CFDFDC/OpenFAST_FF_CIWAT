...
!..................................................................................................................................
   ...
   allocate ( xd%k_mt        (0:p%NumRadii-1, 0:p%NumPlanes-1 ) , STAT=ErrStat2 ) ! Wake added turbulence
   ...
   xd%k_mt                = 0.0_ReKi ! Wake added turbulence
   ...
   allocate (    m%Vx_wind_disk_Plane(0:p%NumPlanes-1 ) , STAT=ErrStat2 ) ! Wake added turbulence
      if (errStat2 /= 0) call SetErrStat ( ErrID_Fatal, 'Could not allocate memory for m%Vx_wind_disk_Plane.', errStat, errMsg, RoutineName )        
   if (errStat /= ErrID_None) return
   
    m%Vx_wind_disk_Plane         = 0.0_ReKi ! Wake added turbulence  
      !............................................................................................
   ...
   allocate ( y%k_mt        (0:p%NumRadii-1, 0:p%NumPlanes-1 ) , STAT=ErrStat2 ) ! Wake added turbulence
   ...
   y%D_wake     = 0.0_Reki
   y%x_plane    = 0.0_Reki
   y%k_mt       = 0.0_Reki ! Wake added turbulence
...
!..................................................................................................................................
  ...
  ! real(DbKi),                     intent(in   ) :: utimes   !< Times associated with u(:), in seconds
   ...
   ! Put new u%x_wind_disk into  m%Vx_wind_disk_Plane array, wake added turbulence
   ...
   ! (CIWAT) Calculate scaling factor k_mt for wake added Turbulence
      do i = 1,maxPln  
         do j = 0,p%NumRadii-1      
            if ( j == 0 ) then
...
!..................................................................................................................................
   ...
   if ( OtherState%firstPass ) then
      ...
      y%k_mt       = xd%k_mt ! Wake added turbulence
